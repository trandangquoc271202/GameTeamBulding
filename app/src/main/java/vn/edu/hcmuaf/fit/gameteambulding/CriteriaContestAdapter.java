...
public class CriteriaContestAdapter extends ArrayAdapter<String> {
    Context context;
    TextView tv_criteria;
    ArrayList<String> list;
    View v_del;
    DetailContestActivity main;
    public CriteriaContestAdapter(@NonNull Context context, DetailContestActivity activity, ArrayList<String> list) {
